...
ark_logo_string = r'<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"	 viewBox="0 0 202 302" style="enable-background:new 0 0 202 302;" xml:space="preserve"><style type="text/css">	.st0{fill:#FFFFFF;}</style><g>	<path class="st0" d="M103.4,188.3V105l72.2,41.7C160.4,171,133.8,187.4,103.4,188.3 M25.9,146.6l72.2-41.7v83.4		C67.6,187.4,41,171,25.9,146.6 M92.8,12.7l-70.3,128c-6.3-12.1-9.8-25.8-9.8-40.3C12.7,54.5,48,16.8,92.8,12.7 M175.5,54.1		l-59,34.1c6.7-9.8,10.4-21.4,10.4-33.5c0-16-6.2-30.8-17.2-41.9C137.5,15.6,161.5,31.5,175.5,54.1 M178.2,58.7		c6.7,12.4,10.5,26.6,10.5,41.7s-3.8,29.3-10.5,41.7L106,100.4L178.2,58.7z M98.1,98.8L30,138.1l68.1-124V98.8z M103.4,95.2V14.1		C115,24.4,121.6,39,121.6,54.7C121.6,70.2,114.9,85,103.4,95.2 M100.7,7.1C49.2,7.1,7.4,49,7.4,100.4s41.9,93.3,93.3,93.3		s93.3-41.9,93.3-93.3S152.2,7.1,100.7,7.1"/></g></svg>'
...
st.sidebar.image(ark_logo_string, use_column_width='always')
